...
class OneD(IdealizedBase):
    file_path = '/Users/pchamberlain/Projects/data_save_utilities/lagrangian/ocean_parcels/OneD/'
    def __init__(self,K_bar = 0,alpha = 0):
        super(OneD,self).__init__(K_bar = K_bar,alpha = alpha)
    ...
    def construct_diffusivity_and_velocity(self):
        ...
        Kh_meridional[:3] = 0
        Kh_meridional[-3:] = 0
        Kh_meridional,_ = np.meshgrid(Kh_meridional,Kh_meridional)
